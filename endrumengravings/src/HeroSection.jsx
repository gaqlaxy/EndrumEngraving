...
const HeroSection = () => {
  useEffect(() => {
    const timer = setTimeout(() => {
      ...
      const headingAnimation = gsap.from(".hero-heading", {
        opacity: 0,
        y: -100,
        duration: 1,
        ease: "power3.out",
      ...
      const descriptionAnimation = gsap.from(".hero-description", {
        opacity: 0,
        y: 50,
        duration: 1,
        delay: 0.5,
      ...
      const buttonAnimation = gsap.from(".explore-button", {
        opacity: 0,
        y: 100,
        duration: 1,
        delay: 1.5, // Add some delay for proper sequencing
        ease: "power3.out",
      });
